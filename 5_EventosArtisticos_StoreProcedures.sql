...
/** con el siguiente SP , se podran insertar registros a partir de parametros que responden
a campos obligatorios de la tabla EMPLEADO, o borrar registros a partir del Id del registro que se 
quiere eliminar.
...
set 
  ...
  (@p_id_emp, @p_Emp_Espec, @p_Emp_Email, @p_Emp_Name, @p_Emp_Lastname , @p_Emp_Phone, @p_Emp_Cuit, @p_Emp_Sueldo);
  ...
  **/
  ...
  (@p_id_emp, @p_Emp_Espec, @p_Emp_Email, @p_Emp_Name, @p_Emp_Lastname , @p_Emp_Phone, @p_Emp_Cuit, @p_Emp_Sueldo);
    ...
    select * from empleado; -- chequeamos que se haya borrado